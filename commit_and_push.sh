cd "/Users/shams/Desktop/taxilibre" && git add infrastructure/variables.tf infrastructure/main.tf infrastructure/services.tf infrastructure/outputs.tf gateway-nginx/nginx.conf TASK_11_SUMMARY.md && git commit -m "feat(infra): configure HTTPS on ALB with ACM certificate

              ...
              <div className="flex items-center space-x-4">
                ...
                {isAuthenticated ? (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="w-8 h-8 bg-blue-100 rounded-flex flex items-center justify-center" aria-hidden="true">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>
                    <Link to="/book-ride" className="hover:text-gray-900">
                      Book a Ride
                    </Link>
                  </li>
                  <li>
                    <Link to="/ride-history" className="hover:text-gray-900">
                      Ride History
                    </Link>
                  </li>
                  <li>
